...
public class InitScript2 : MonoBehaviour {
    ...
    public Rect dropDownRect = new Rect(325,425,125,300); // Choose mode
	public Rect dropDownFileRect = new Rect(125, 425, 125, 300); // Choose character input file
	public Rect dropDownScriptRect = new Rect(525,425,125,300); // Choose script file
	public Rect dropDownActionRect = new Rect(725, 425, 125, 300); // Choose action 
	public Rect dropDownCharRect = new Rect(925, 425, 125, 300); // Choose actor or character 125, 390, 100, 30
	public Rect dropDownTargetRect = new Rect(1125, 425, 125, 300); // Choose target pawn, mark, or char
    public static string[] mlist = {"Choose Mode:","Baseline", "Random", "NLP", "Rules", "FDG"};
	public static string[] filelist = {};
	public static string[] fullfilelist = {};
	public static string[] actionlist = {"Choose Action:", "Walk", "Look", "Pickup", "Putdown", "Speak", "Point"};
	public static GameObject[] charlist = {};
	public static GameObject[] targetlist = {};
	...
	void Start () {
		...
		//fullfilelist.Insert (0, "Select File:");
		//filelist.Insert (0, "Select File:");
	}
		...
		if (intermission) {
			...
			if (started) {
		        ...
		        if(charshow)
		        {
					...
					charViewVector = GUI.BeginScrollView(new Rect((dropDownCharRect.x - 100), (dropDownCharRect.y + 25), dropDownCharRect.width, dropDownCharRect.height),charViewVector,new Rect(0, 0, dropDownCharRect.width, Mathf.Max(dropDownCharRect.height, (charlist.Length*25))));
		            GUI.Box(new Rect(0, 0, dropDownCharRect.width, Mathf.Max(dropDownCharRect.height, (charlist.Length*25))), "");           
		            ...
		            {               
		                ...
		                GUI.Label(new Rect(5, (index*25), dropDownCharRect.height, 25), charlist[index].name);               
		            }
		            GUI.EndScrollView();   
				}
		        else
		        {
		            ...
		            GUI.Label(new Rect((dropDownCharRect.x - 95), dropDownCharRect.y, 300, 25), "Choose Char");
		        }
		        ...
		        if(targetshow)
		        {
					...
					targetViewVector = GUI.BeginScrollView(new Rect((dropDownTargetRect.x - 100), (dropDownTargetRect.y + 25), dropDownTargetRect.width, dropDownTargetRect.height),targetViewVector,new Rect(0, 0, dropDownTargetRect.width, Mathf.Max(dropDownTargetRect.height, (targetlist.Length*25))));
		            GUI.Box(new Rect(0, 0, dropDownTargetRect.width, Mathf.Max(dropDownTargetRect.height, (targetlist.Length*25))), "");           
		            ...
		            {               
		                ...
		                GUI.Label(new Rect(5, (index*25), dropDownTargetRect.height, 25), targetlist[index].name);               
		            }
		            GUI.EndScrollView();   
				}
		        else
		        {
		            GUI.Label(new Rect((dropDownTargetRect.x - 95), dropDownTargetRect.y, 300, 25), "Choose target");
		        }
				...
				txtsay = GUI.TextField (new Rect(1050, 350, 150, 30), txtsay, 100);
				
				// run action
				if (GUI.Button (new Rect(925, 270, 200, 30), "Click to do Action")) {
					RunAction();	
				}
/*				
...
/*
				...
				*/
				...
				if (GUI.Button (new Rect(925, 25, 100, 30), "Start Play")) {
...
//		callNextStep ();
	...
	public static void LoadChars() {
		...
		charlist[0] = GlobalObjs.Hamlet;
		charlist[1] = GlobalObjs.Horatio;
		charlist[2] = GlobalObjs.GraveDigger;
		charlist[3] = GlobalObjs.GraveDiggerTwo;
		
		targetlist = new GameObject[20];
		targetlist[0] = GlobalObjs.Hamlet;
		targetlist[1] = GlobalObjs.Horatio;
		targetlist[2] = GlobalObjs.GraveDigger;
		targetlist[3] = GlobalObjs.GraveDiggerTwo;
		targetlist[4] = GlobalObjs.Skull1;
		targetlist[5] = GlobalObjs.Skull2;
		targetlist[6] = GlobalObjs.Shovel;
		targetlist[7] = GlobalObjs.Lantern;
